...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/book/addBook" method="get" class="form-horizontal">
...
<%--                <input type="text"  class="form-control" >--%>
                <textarea name="detail" class="form-control" rows="3" id="bkdetail" ></textarea>
            </div>
        </div>
        <div class="form-group">
